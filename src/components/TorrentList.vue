      ...
      <table class="table w-full text-gray-400 border-separate space-y-6 text-sm">
        ...
        <tbody>
          <tr class="text-center cursor-pointer duration-100 hover:bg-blue-100" v-for="i in 16" :key="i">
            <td class="p-3 border-2 border-r-0 border-gray-200">
            ...
            <td class="p-3 border-t-2 border-b-2 border-gray-200">
            ...
            <td class="p-3 border-2 border-l-0 border-gray-200">
              <span class="text-blue-400 font-semibold">Warm Beer</span>
            </td>
          </tr>
        </tbody>
      </table>
